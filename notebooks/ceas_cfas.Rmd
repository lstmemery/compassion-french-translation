...
```{r}
ceas_sc_level_one_fit <- fit_measure
```
...
```{r}
ceas_sc_level_two_fit <- fit_measure
```
...
```{r}
ceas_from_level_one_fit <- fit_measure
```
...
```{r}
ceas_to_level_one_fit <- fit_measure
```
